...
class Ladybug(Card):
    ...
    def effectsInit(self):
        self.initEffect(Ladybug_InheritedSwarm)



"""
1OT:<被战斗破坏时>:从卡组把1只攻击力1500以下的暗属性怪兽攻击表示特殊召唤。
1OT:<When destroyed by battle>: Special Summon 1 DARK monster with 1500 ATK or less from your Deck in Attack Position.
"""
class Ladybug_InheritedSwarm(Effect):
    ...
    def y_cost(self, justCheck: bool, signal):
        ...
        def isTarget(card):
            return c.atk <= 1500 and c.attr == ATTR.DARK
