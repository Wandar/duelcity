...
class JapaneseHornet(Card):
    ...
    def effectsInit(self):
        self.initEffect(JapaneseHornet_InheritedSwarm)



"""
1OT:<被战斗破坏时>:从卡组把1只攻击力1500以下的水属性怪兽攻击表示特殊召唤。
1OT:<When destroyed by battle>: Special Summon 1 WATER monster with 1500 ATK or less from your Deck in Attack Position.
"""
class JapaneseHornet_InheritedSwarm(Effect):
    ...
    def y_cost(self, justCheck: bool, signal):
        ...
        def isTarget(card):
            return c.atk <= 1500 and c.attr == ATTR.WATER
